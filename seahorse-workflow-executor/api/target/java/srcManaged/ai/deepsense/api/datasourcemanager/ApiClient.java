...
import ai.deepsense.api.datasourcemanager.auth.HttpBasicAuth;
import ai.deepsense.api.datasourcemanager.auth.ApiKeyAuth;
import ai.deepsense.api.datasourcemanager.auth.OAuth;
import ai.deepsense.api.datasourcemanager.auth.OAuth.AccessTokenListener;
import ai.deepsense.api.datasourcemanager.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "http://localhost/datasourcemanager/v1";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
